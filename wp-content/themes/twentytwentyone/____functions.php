...
function payment_gateway($request)
{
    ...
    /* PHP */
    $post_data = array();
    $post_data['store_id'] = "dcast5ff6c346f2850";
    $post_data['store_passwd'] = "dcast5ff6c346f2850@ssl";
    $post_data['total_amount'] = $total;
    $post_data['currency'] = $curency;
    $post_data['tran_id'] = $tran_id;
    $post_data['success_url'] = "https://shantalifestyle.qwikq.net/payment-process";
    $post_data['fail_url'] = "https://shantalifestyle.qwikq.net/payment-failed";
    $post_data['cancel_url'] = "https://shantalifestyle.qwikq.net/payment-cancle";
...
function get_all_prodcut()
{
    ...
    foreach ($args as $single) {
        ...
        foreach ($oldAttr as $key => $attr) {
            foreach (get_the_terms($single->id, $attr['name']) as $key => $term) {
