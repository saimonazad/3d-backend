    ...
    return this.each(function() {
      ...
      $(this).animate({
        ...
        step: function( progress ){
          ...
          if ( labelEl.innerWidth() > 0 ) {
            if ( labelEl.innerWidth() >= progressEl.innerWidth() ) {
              labelEl.css('marginRight', ( labelEl.innerWidth() + 20 ) * -1 );
              labelEl.addClass('outer');
            } else {
              labelEl.css('marginRight', 'auto' );
              labelEl.removeClass('outer');
            }
          }
