...
<div class="wc-order-data-row wc-order-totals-items wc-order-items-editable">
	...
	<table class="wc-order-totals">
        ...
        <tr>
            <td class="label"><?php esc_html_e( 'Delivery Fee', 'woocommerce' ); ?>:</td>
            <td width="1%"></td>
            <td class="total">
                <?php echo wc_price( $deliveryfee['cost'], array( 'currency' => $order->get_currency() ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
            </td>
        </tr>
        ...
        <tr>
            <td class="label"><?php esc_html_e( 'Partial Payment', 'woocommerce' ); ?>:</td>
            <td width="1%"></td>
            <td class="total">
                <?php 							echo wc_price( wc_round_tax_total( $partial_payment ), array( 'currency' => $order->get_currency() ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        ...
        <tr>
            <td class="label"><?php esc_html_e( 'Due', 'woocommerce' ); ?>:</td>
            <td width="1%"></td>
            <td class="total">
                <?php 							echo wc_price( wc_round_tax_total( $due ), array( 'currency' => $order->get_currency() ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
