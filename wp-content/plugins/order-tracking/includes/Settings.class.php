	...
	public function premium_info( $section_and_perm_type ) {
		...
		$premium_features = '
			...
			<div class="ewd-otp-dashboard-new-footer-one-buttons">
				<a class="ewd-otp-dashboard-new-upgrade-button" href="https://www.etoilewebdesign.com/license-payment/?Selected=OTP&Quantity=1" target="_blank">' . __( 'UPGRADE NOW', 'order-tracking' ) . '</a>
			</div>
		';
