				...
				<div class="ewd-otp-dashboard-new-widget-box-bottom">
					...
					<div class='ewd-otp-field'>
						...
						<div class='ewd-otp-admin-input'>
							...
							<input type='text' name="ewd_otp_public_notes" value="<?php echo ( ! empty( $this->order->notes_public ) ? esc_attr( $this->order->notes_public ) : '' ); ?>" />
					...
					<div class='ewd-otp-field'>
						...
						<div class='ewd-otp-admin-input'>
							...
							<input type='text' name="ewd_otp_private_notes" value="<?php echo ( ! empty( $this->order->notes_private ) ? esc_attr( $this->order->notes_private ) : '' ); ?>" />
					...
					<div class='ewd-otp-field'>
						...
						<div class='ewd-otp-admin-input'>
							...
							<input type='text' name="ewd_otp_customer_notes" value="<?php echo ( ! empty( $this->order->customer_notes ) ? esc_attr( $this->order->customer_notes ) : '' ); ?>" />
