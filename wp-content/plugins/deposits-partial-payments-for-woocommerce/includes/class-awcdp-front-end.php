...
class AWCDP_Front_End
{
    ...
    function awcdp_deposits_form($product_id, $price = false){
      ...
      if ($product_id){
        ...
        if ($product && $enabled) {
         ...
         // error_log(print_r( $deposit_amount, true));
  ...
  function awcdp_get_deposit_amount($product_id){
          ...
          if ($product) {
              ...
              if ($deposit_enabled && isset($cart_item_data['awcdp_deposit'], $cart_item_data['awcdp_deposit']['enable'] ) && $cart_item_data['awcdp_deposit']['enable'] == 1 ) {
                  ...
                  switch($amount_type){
                      ...
                      // error_log(print_r( $deposit_amount_meta, true));
                      ...
                      // error_log(print_r( $cart_item_data['awcdp_deposit']['original_price'], true));
                      //error_log(print_r( $cart_item_data, true));
                      // error_log(print_r( $amount, true));
                      // error_log(print_r( $deposit_amount_meta, true));
                      // error_log(print_r( $deposit, true));
    ...
    function awcdp_calculated_total($cart_total, $cart) {
        ...
        // error_log(print_r( $payment_schedule, true));
